...
public:
  Camera();
  ~Camera();
  X_Vector position = X_Vector(Window::S_WIDTH/ 2.f,Window::S_HEIGHT/ 2.f,0);
  static Camera main;
  glm::mat4 Projection = glm::ortho(-0.5f, (Window::S_WIDTH- 1) + 0.5f, -0.5f, (Window::S_HEIGHT - 1.0f) + 0.5f,-1000.f,1000.f);
  //glm::mat4 Projection = glm::ortho(0.f, (float)Window::S_WIDTH, (float)Window::S_HEIGHT, 0.f,-1000.f,1000.f);
